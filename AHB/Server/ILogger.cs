...
namespace AHB.Server
{
    public interface ILogger
    {
        ...
        bool IsEnabled(Core.LogLevel level);
        ...
        Task<IPagedList<Log>> GetAllLogsAsync(DateTime? fromUtc = null, DateTime? toUtc = null,
            string message = "", Core.LogLevel? logLevel = null,
        ...
        /// </returns>
        Task<Log> InsertLogAsync(Core.LogLevel logLevel, string shortMessage, string fullMessage = "", Customer customer = null);
