namespace AHB.Core
{
    public static partial class RsEntityCacheDefaults<TEntity> where TEntity : BaseEntity
    {
        /// <summary>
        ...
        /// {0} : entity id
        /// </remarks>
        public static CacheKey ByIdCacheKey => new($"Rs.{EntityTypeName}.byid.{{0}}", ByIdPrefix, Prefix);
        ...
        /// {0} : entity ids
        /// </remarks>
        public static CacheKey ByIdsCacheKey => new($"Rs.{EntityTypeName}.byids.{{0}}", ByIdsPrefix, Prefix);

        /// <summary>
        /// Gets a key for caching all entities
        /// </summary>
        public static CacheKey AllCacheKey => new($"Rs.{EntityTypeName}.all.", AllPrefix, Prefix);
