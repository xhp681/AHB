...
namespace AHB.DataBase
{
    ...
    {
        protected static ConcurrentDictionary<Type, RsEntityDescriptor> EntityDescriptors { get; } = new ConcurrentDictionary<Type, RsEntityDescriptor>();
        ...
        public virtual RsEntityDescriptor GetEntityDescriptor(Type entityType)
        {
            return EntityDescriptors.GetOrAdd(entityType, t =>
            {
                ...
                return new RsEntityDescriptor
                {
                    EntityName = tableName,
                    Fields = builder.Expression.Columns.Select(column => new RsEntityFieldDescriptor
                    {
                        Name = column.Name,
