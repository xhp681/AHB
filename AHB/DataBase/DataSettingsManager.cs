...
namespace AHB.DataBase
{
    public class DataSettingsManager
    {
        ...
        /// <returns>Data settings</returns>
        public static DataConfig LoadSettings(IRsFileProvider fileProvider = null, bool reload = false)
        {
            ...
            var filePath_json = fileProvider.MapPath(RsDataSettingsDefaults.FilePath);
            var filePath_txt = fileProvider.MapPath(RsDataSettingsDefaults.ObsoleteFilePath);
        ...
        /// <param name="fileProvider">File provider</param>
        public static void SaveSettings(DataConfig dataSettings, IRsFileProvider fileProvider)
        {
            AppSettingsHelper.SaveAppSettings(new List<IConfig> { dataSettings }, fileProvider);
